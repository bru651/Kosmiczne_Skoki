...
public:
    ...
    MovingCircle(float radius, float angle, float speed, float size, sf::Color color, float mass);  //Constructor
...
public:
    ...
    Rocket(float startX, float startY, float mass, unsigned int ID, sf::Vector2f initVelocity); // Constructor 
